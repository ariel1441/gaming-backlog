...
export const listGames = celebrate({
  [Segments.QUERY]: Joi.object({
    ...
    sort: Joi.string().valid("name", "status", "personal_genres", "estimated_hours", "score", "hours_played", "rawg_rating", "metacritic", "release_date", "added_date", "started_date", "finished_date", "steam_last_played").allow("").default(""),
    ...
    date_days: Joi.number().integer().min(1).max(3650),
